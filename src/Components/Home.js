            ...
            <section className='grid justify-between md:grid-cols-2 space-x-4 max-sm:space-x-2 max-sm:grid-cols-1 py-8 px-4 max-sm:px-2 '>
                ...
                <div className="grid grid-cols-2 gap-2 py-8 ">
                    ...
                    <div className="relative h-64">
                        ...
                        <h1 className="text-white text-center text-lg w-full absolute rounded-b-md bottom-0 p-2 px-8 bg-[rgba(0,0,0,0.5)]">Business & Agribusiness Consulting </h1>
                    </div>
                    <div className="relative ">
                        <video
                            className="w-full rounded-md h-full object-cover transition-shadow duration-700 "
...
<section className='grid justify-between md:grid-cols-2 max-sm:grid-cols-1 py-20 max-sm:py-2 px-4  '>
    ...
    <section className='grid grid-cols-3 max-sm:grid-cols-1 gap-8 p-6 max-sm:p-4 py-16 max-sm:py-2'>
                ...
                <div className="flex flex-col justify-evenly border-[1px] boder-green-700 bg-green-50 items-center w-full space-y-8 shadow-md rounded-md p-16">
                    <IoIosEye className="text-7xl text-green-700" />
                    <h1 className="text-2xl w-full font-bold mb-4 bg-green-700 text-white p-2">Vision</h1>
                    <div className="text-lg text-justify">
                ...
                <div className="flex flex-col items-center bg-blue-50 border-[1px] boder-blue-700 justify-evenly w-full space-y-8 shadow-lg rounded-md p-10">
                    <TbBulbFilled className="text-7xl text-blue-700" />
                    <h1 className="text-2xl w-full font-bold mb-4 bg-blue-700 text-white p-2">Core Values</h1>
                    <div className="text-lg text-justify">
                        <ul list-disc pl-5 className="grid grid-cols-2">
